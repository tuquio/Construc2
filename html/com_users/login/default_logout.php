...
<div class="line account logout">
	...
	<?php if ($_desc) { echo $this->params->get('logout_description'); } ?>
	<?php if ($_image) { ?><img src="<?php echo $this->escape($this->params->get('logout_image')) ?>" class="logout-image" alt="<?php echo JTEXT::_('COM_USER_LOGOUT_IMAGE_ALT')?>"/><?php } ?>
	</div>
	<?php } ?>
