/**
 * DD_belatedPNG: Adds IE6 support: PNG images for CSS
 * background-image and HTML <IMG/>. Author: Drew Diller Email:
 * drew.diller@gmail.com URL:
 * http://www.dillerdesign.com/experiment/DD_belatedPNG/ Version:
 * 0.0.8a Licensed under the MIT License:
 * http://dillerdesign.com/experiment/DD_belatedPNG/#license
 * Example usage: DD_belatedPNG.fix('.png_bg'); // argument is a
 * CSS selector DD_belatedPNG.fixPng( someNode ); // argument is
 * an HTMLDomElement
 */
var DD_belatedPNG =
        {
            ...
            vmlOpacity : function(b) {
	            if (b.currentStyle.filter.search("lpha") != -1) {
		            ...
		            a =
		                    parseInt(a.substring(a.lastIndexOf("=") + 1, a
		                            .lastIndexOf(")")), 10) / 100;
            ...
            vmlOffsets : function(d) {
	            ...
	            e(d.vml.image.shape, (n.L + n.bLW), (n.T + n.bTW), (n.W),
	                    (n.H), 1);
	            g = {
	                X : 0,
	                Y : 0
	            ...
	            if (m != "repeat" || d.isImg) {
		            ...
		            d.vml.image.shape.style.clip =
		                    "rect(" + i.T + "px " + (i.R + a) + "px " + i.B
		                            + "px " + (i.L + a) + "px)";
	            } else {
		            d.vml.image.shape.style.clip =
		                    "rect(" + f.T + "px " + f.R + "px " + f.B + "px "
		                            + f.L + "px)";
	            }
            },
            ...
            fixPng : function(c) {
	            ...
	            var g, b, f, a, d;
	            if (c.nodeName == "BODY" || c.nodeName == "TD"
	                    || c.nodeName == "TR") {
		            return
	            }
	            c.isImg = false;
	            if (c.nodeName == "IMG") {
		            ...
		            if (c.currentStyle.backgroundImage.toLowerCase().search(
		                    ".png") == -1) {
			            return
		            }
	            }
