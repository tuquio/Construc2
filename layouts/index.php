			...
			<?php if ($navBelowCount) : ?>
				...
				<?php if ($navBelowCount[1]) : ?>
					<div id="nav-below-1" class="<?php echo $navBelowClass ?>">
						<jdoc:include type="modules" name="nav-below-1" style="jexhtml" module-class="mod" />
					</div><!-- end nav-below-1 -->
				<?php endif; ?>

				<?php if ($navBelowCount[2]) : ?>
					<div id="nav-below-2" class="<?php echo $navBelowClass ?>">
						<jdoc:include type="modules" name="nav-below-2" style="jexhtml" module-class="mod" />
					</div><!-- end nav-below-2 -->
				<?php endif; ?>

				<?php if ($navBelowCount[3]) : ?>
					<div id="nav-below-3" class="<?php echo $navBelowClass ?>">
						<jdoc:include type="modules" name="nav-below-3" style="jexhtml" module-class="mod" />
					</div><!-- end nav-below-3 -->
				<?php endif; ?>

				<?php if ($navBelowCount[4]) : ?>
					<div id="nav-below-4" class="<?php echo $navBelowClass ?>">
						<jdoc:include type="modules" name="nav-below-4" style="jexhtml" module-class="mod" />
					</div><!-- end nav-below-4 -->
				<?php endif; ?>

				<?php if ($navBelowCount[5]) : ?>
					<div id="nav-below-5" class="<?php echo $navBelowClass ?>">
						<jdoc:include type="modules" name="nav-below-5" style="jexhtml" module-class="mod" />
					</div><!-- end nav-below-5 -->
				<?php endif; ?>

				<?php if ($navBelowCount[6]) : ?>
					<div id="nav-below-6" class="<?php echo $navBelowClass ?>">
						<jdoc:include type="modules" name="nav-below-6" style="jexhtml" module-class="mod" />
					</div><!-- end nav-below-6 -->
				<?php endif; ?>
				</div><!-- end nav-below -->
			<?php endif; ?>
